...
public class ServiceTest 
{
	public static void main( String[] args ) throws ServiceException
	{
		...
		try
		{
			...
			mserv.create("DELAJUNGLE", "George", "56 quai des bananiers", "g2lajunge@hotmail.com", "0656869624"); // Creer un membre
		...
		try
		{
			...
			lserv.create("Incendies", "Wajdi Mouawad", "656-29456668"); // Creer un livre
